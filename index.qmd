---
title: "TRACEing EpiNow2"
subtitle: "Forecasting infectious disease trends with EpiNow2"
...
* With `_opts()` function:
    ...
    - delay distribution: `delays_opts()`
...
## The default model is customisable {transition="fade-in"}
...
<!-- - It implements best practices for $R_t$ estimation, including accounting for delays and right truncation. -->
...
<!-- - `{EpiNow2}` can also estimate secondary outcomes (hospitalisations, deaths, etc) from primary observations (cases). -->
<!-- - The package is built on `Stan`, providing robust and efficient model fitting capabilities. -->
